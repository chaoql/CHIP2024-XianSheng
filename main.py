...
if __name__ == '__main__':
    ...
    # if hybrid_search:
    #     index1, nodes1 = rag.load_data("data/trainTaskTXT1.json", "store05")
    #     index2, nodes2 = rag.load_data("data/trainTaskTXT2.json", "store06")
    #     index3, nodes3 = rag.load_data("data/trainTaskTXT3.json", "store07")
    #     index4, nodes4 = rag.load_data("data/trainTaskTXT4.json", "store08")
    # else:
    #     index1, nodes1 = rag.load_data("data/trainTask1.json", "store01")
    #     index2, nodes2 = rag.load_data("data/trainTask2WOoptions.json", "store02")
    #     index3, nodes3 = rag.load_data("data/trainTask3WOoptions.json", "store03")
    ...
    for i, info in tqdm(enumerate(infoList), total=len(infoList)):
        ...
        rag_query_engine = rag.Build_query_engine(rerank_top_k, hybrid_mode, index1, top_k, hybrid_search,
                                                  nodes1, with_hyde, qa_prompt_tmpl=prompt1)
        ...
        rag_query_engine = rag.Build_query_engine(rerank_top_k, hybrid_mode, index2, top_k, hybrid_search,
                                                  nodes2, with_hyde,
        ...
        rag_query_engine = rag.Build_query_engine(rerank_top_k, hybrid_mode, index3, top_k, hybrid_search,
                                                  nodes3, with_hyde,
        ...
        rag_query_engine = rag.Build_query_engine(rerank_top_k, hybrid_mode, index4, top_k, hybrid_search,
                                                  nodes4, with_hyde,
