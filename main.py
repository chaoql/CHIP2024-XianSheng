...
if __name__ == '__main__':
    ...
    if hybrid_search:
        ...
        # index1, nodes1 = rag.load_hybrid_data(["data/trainTaskTXT1.txt"], "store/hybrid_store01")
        # index2, nodes2 = rag.load_hybrid_data(["data/trainTaskTXT2.txt"], "store/hybrid_store02")
        # index3, nodes3 = rag.load_hybrid_data(["data/trainTaskTXT3.txt"], "store/hybrid_store03")
        # index4, nodes4 = rag.load_hybrid_data(["data/trainTaskTXT4.txt"], "store/hybrid_store04")
    else:
        ...
        index2, nodes2 = rag.load_data(["data/trainTask2WOoptions3.json"], "store/store02_3")
