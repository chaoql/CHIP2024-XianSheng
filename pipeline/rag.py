...
def Build_query_engine(with_LLMrerank, rerank_top_k, hybrid_mode, index, top_k, hybrid_search, nodes, with_hyde,
                       qa_prompt_tmpl):
    # qa_prompt_tmpl = PromptTemplate(qa_prompt_tmpl)
    rag_query_engine = build_query_engine(with_LLMrerank, rerank_top_k, hybrid_mode, index, ResponseMode.COMPACT,
                                          qa_prompt_tmpl,
